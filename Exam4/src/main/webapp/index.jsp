		...
		<div class="right">
			...
			<div>
				<input type="button" class="btn btn-success "
					style="margin-left: 200px" value="新建"
	...
	int curPage = 1;%>
				...
				<div style="text-align: center">
					...
					<div class="btn-group " style="float: right" id="btn-g">
						...
						<a class="btn btn-success" href="index.jsp?curPage=1">首页</a>
						 <a
							class="btn btn-success" href="index.jsp?curPage=<%=curPage - 1%>">上一页</a>


						<a class="btn btn-success"	href="index.jsp?curPage=<%=curPage + 1%>">下一页</a> 
							<a	class="btn btn-success" href="index.jsp?curPage=<%=pageCount%>">尾页</a>
